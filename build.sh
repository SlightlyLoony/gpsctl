#!/bin/bash
cd ~/gpsctl
gcc -std=c11 -Wall -rdynamic -g -fno-omit-frame-pointer -funwind-tables -mapcs -mno-sched-prolog -o gpsctl gpsctl.c sl_general.c sl_serial.c sl_buffer.c sl_bits.c cJSON.c ublox.c
#
